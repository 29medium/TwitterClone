...
class FriendshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friendship" do
    assert_difference('Friendship.count') do
      post friendships_url, params: { friendship: { friend_id: @friendship.friend_id, user_id_id: @friendship.user_id_id } }
    end
  ...
  test "should update friendship" do
    patch friendship_url(@friendship), params: { friendship: { friend_id: @friendship.friend_id, user_id_id: @friendship.user_id_id } }
